...
'loading' === document.readyState ? document.addEventListener('livewire:navigated', (function () {
    KTComponents.init();
    ...
    return {
        init: function () {
            ...
            !function () {
                ...
                speed: 1e3, speedAsDuration: !0, offset: function (e, t) {
                ...
                if (this.classList.contains('collapsed') ? (this.classList.remove('active'), this.blur()) : this.classList.add('active'), this.hasAttribute('data-kt-toggle-text')) {
                    var t = this.getAttribute('data-kt-toggle-text'), n = (n = this.querySelector('[data-kt-toggle-text-target="true"]')) || this;
                ...
                if ('undefined' != typeof jQuery && void 0 !== $.fn.daterangepicker) {
                    var e = [].slice.call(document.querySelectorAll('[data-kt-daterangepicker="true"]')), t = moment().subtract(29, 'days'), n = moment();
                    e.map((function (e) {
                        if ('1' !== e.getAttribute('data-kt-initialized')) {
                            var i = e.querySelector('div'), r = e.hasAttribute('data-kt-daterangepicker-opens') ? e.getAttribute('data-kt-daterangepicker-opens') : 'left', o = function (e, t) {
                                var n = moment();
                ...
                if ('1' !== e.getAttribute('data-kt-initialized')) {
                    var t = e.hasAttribute('data-kt-buttons-target') ? e.getAttribute('data-kt-buttons-target') : '.btn', n = [].slice.call(e.querySelectorAll(t));
...
var KTBlockUI = function (e, t) {
    var n = this;
    if (null != e) {
        var i = {zIndex: !1, overlayClass: '', overflow: 'hidden', message: '<span class="spinner-border text-primary"></span>'}, r = function () {
        ...
        KTUtil.data(e).has('blockui') ? n = KTUtil.data(e).get('blockui') : r(), n.block = function () {
            !function () {
                if (!1 !== KTEventHandler.trigger(n.element, 'kt.blockui.block', n)) {
                    var e = 'BODY' === n.element.tagName, t = KTUtil.css(n.element, 'position'), i = KTUtil.css(n.element, 'overflow'), r = e ? 1e4 : 1;
...
var KTDrawerHandlersInitialized = !1, KTDrawer = function (e, t) {
    ...
    if (null != e) {
        var i = {overlay: !0, direction: 'end', baseClass: 'drawer', overlayClass: 'drawer-overlay'}, r = function () {
            ...
            var e = f(), t = m('direction'), i = m('top'), r = m('bottom'), o = m('start'), a = m('end');
...
var KTMenuHandlersInitialized = !1, KTMenu = function (e, t) {
    var n = this;
    if (null != e) {
        var i = {dropdown: {hoverTimeout: 200, zindex: 107}, accordion: {slideSpeed: 250, expand: !1}}, r = function () {
            ...
            if (!1 !== KTEventHandler.trigger(n.element, 'kt.menu.dropdown.show', e)) {
                ...
                c(e) || p(e);
                var t = g(e), i = L(e, 'width'), r = L(e, 'height'), o = n.options.dropdown.zindex, a = KTUtil.getHighestZindex(e);
            ...
            return 2 === i.length && (i[0] = parseInt(i[0]), i[1] = parseInt(i[1])), {
                ...
                modifiers: [{name: 'offset', options: {offset: i}}, {name: 'preventOverflow', options: {altAxis: !1 !== L(e, 'flip')}}, {name: 'flip', options: {flipVariations: !1}}]
            };
        }, A = function (e) {
        ...
        !0 === KTUtil.data(e).has('menu') ? n = KTUtil.data(e).get('menu') : r(), n.click = function (e, t) {
            ...
            return function (e) {
                var t = T(e);
                if (t) {
                    var i = K(t), r = e.closest('.tab-pane'), o = [].slice.call(n.element.querySelectorAll('.menu-link.active')), a = [].slice.call(n.element.querySelectorAll('.menu-item.here, .menu-item.show'));
                    ...
                    if (o.map((function (e) {
                        ...
                        var d = n.element.querySelector('[data-bs-target="#' + r.getAttribute('id') + '"]'), c = new bootstrap.Tab(d);
                        c && c.show();
                    }
...
var KTPasswordMeter = function (e, t) {
    var n = this;
    if (e) {
        var i = {minLength: 8, checkUppercase: !0, checkLowercase: !0, checkDigit: !0, checkChar: !0, scoreHighlightClass: 'active'}, r = function () {
            ...
            var e = n.visibilityElement.querySelector(':scope > i:not(.d-none)'), t = n.visibilityElement.querySelector(':scope > i.d-none');
...
var KTSearch = function (e, t) {
    var n = this;
    if (e) {
        var i = {minLength: 2, keypress: !0, enter: !0, layout: 'menu', responsive: null, showOnFocus: !0}, r = function () {
...
var KTStepper = function (e, t) {
    var n = this;
    if (null != e) {
        var i = {startIndex: 1, animation: !1, animationSpeed: '0.3s', animationNextClass: 'animate__animated animate__slideInRight animate__fast', animationPreviousClass: 'animate__animated animate__slideInLeft animate__fast'}, r = function () {
...
var KTStickyHandlersInitialized = !1, KTSticky = function (e, t) {
    var n = this;
    if (null != e) {
        var i = {offset: 200, reverse: !1, release: null, animation: !0, animationSpeed: '0.3s', animationClass: 'animation-slide-in-down'}, r = function () {
            ...
            var t = u('top');
            t = t ? parseInt(t) : 0;
            var i = u('left'), r = u('right'), o = u('width'), a = u('zindex'), l = u('dependencies'), d = u('class'), c = s(), m = u('height-offset');
...
var KTUtil = function () {
    ...
    return {
        init: function (e) {
            ...
            var i = Element.prototype, r = i.matches || i.webkitMatchesSelector || i.mozMatchesSelector || i.msMatchesSelector || function (e) {
            ...
            var t, n;
            if (e) return e.getClientRects().length ? (t = e.getBoundingClientRect(), n = e.ownerDocument.defaultView, {top: t.top + n.pageYOffset, left: t.left + n.pageXOffset, right: window.innerWidth - (e.offsetLeft + e.offsetWidth)}) : {top: 0, left: 0};
        }, height: function (e) {
            ...
            let t = e.getBoundingClientRect().left, n = e.getBoundingClientRect().top, i = Math.max(document.documentElement.clientWidth, window.innerWidth || 0), r = Math.max(document.documentElement.clientHeight, window.innerHeight || 0), o = e.clientWidth, a = e.clientHeight;
            return n < r && n + a > 0 && t < i && t + o > 0;
        }, onDOMContentLoaded: function (e) {
            'loading' === document.readyState ? document.addEventListener('livewire:navigated', e) : e();
        }, inIframe: function () {
            try {
        ...
        init: function () {
            ...
            (a = document.querySelector('#kt_app_engage'), s = document.querySelector('#kt_app_engage_toggle_on'), l = document.querySelector('#kt_app_engage_toggle_off'), u = document.querySelector('#kt_app_engage_prebuilts_modal'), a && u && (null !== u && '1' !== KTCookie.get('app_engage_prebuilts_modal_displayed') && setTimeout((function () {
                ...
                KTUtil.on(u, '[data-kt-mode]', 'click', (function (n) {
                    const i = this.innerText, r = this.getAttribute('data-kt-mode'), o = t.querySelector('.menu-link.active'), a = document.querySelector('#kt_app_engage_prebuilts_view_image'), l = document.querySelector('#kt_app_engage_prebuilts_view_text');
                ...
                $.ajax({
                    type: 'POST', dataType: 'html', url: n, data: o, success: function (e, t, i) {
                        var o = setInterval((function () {
                            $('<iframe/>').attr({src: n + '?layout-builder[action]=export&download=1&output=' + e, style: 'visibility:hidden;display:none'}).ready((function () {
...
var KTAppSidebar = function () {
    ...
    return {
        init: function () {
            ...
            })))), i && (l = i.querySelector('.menu-link.active')) && !0 !== KTUtil.isVisibleInContainer(l, i) && i.scroll({top: KTUtil.getRelativeTopPosition(l, i), behavior: 'smooth'}), n && n.addEventListener('hide.bs.collapse', (e => {
...
var KTLayoutToolbar = {
    init: function () {
        document.querySelector('#kt_app_toolbar') && function () {
            ...
            if (e) {
                noUiSlider.create(e, {start: [5], connect: [!0, !1], step: 1, format: wNumb({decimals: 1}), range: {min: [1], max: [10]}}), e.noUiSlider.on('update', (function (e, n) {
                    t.innerHTML = e[n];
                }));
