...
it('create category', function (array $payload = [], array $expected = []) {
    ...
    $response = login(permissions: Arr::get($payload, 'permissions', [SharedPermissions::Admin]))->postJson('api/v1/portfolio', $data);
    ...
    'default data with permission'    => [
        'payload'  => ['permissions' => [PortfolioPermissions::Store]],
        'expected' => ['status' => 201]
    ],
