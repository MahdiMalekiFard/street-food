...
it('update menuItem', function (array $payload = [], array $expected = []) {
    ...
    $response = login(permissions: Arr::get($payload, 'permissions', [SharedPermissions::Admin]))->patchJson('api/v1/menu-item/' . $model->id, $data);
    ...
    'default data with permission'    => [
        'payload'  => ['permissions' => [MenuItemPermissions::Update]],
        'expected' => ['status' => 202]
    ],
