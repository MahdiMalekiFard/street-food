...
it('create category', function (array $payload = [], array $expected = []) {
    ...
    $response = login(permissions: Arr::get($payload, 'permissions', [SharedPermissions::Admin]))->postJson('api/v1/menu-item', $data);
    ...
    'default data with permission'    => [
        'payload'  => ['permissions' => [MenuItemPermissions::Store]],
        'expected' => ['status' => 201]
    ],
