...
it('create category', function (array $payload = [], array $expected = []) {
    ...
    $response = login(permissions: Arr::get($payload, 'permissions', [SharedPermissions::Admin]))->postJson('api/v1/setting', $data);
    ...
    'default data with permission'    => [
        'payload'  => ['permissions' => [SettingPermissions::Store]],
        'expected' => ['status' => 201]
    ],
