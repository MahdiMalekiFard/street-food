...
it('create category', function (array $payload = [], array $expected = []) {
    ...
    $response = login(permissions: Arr::get($payload, 'permissions', [SharedPermissions::Admin]))->postJson('api/v1/category', $data);
    ...
    'default data with permission'    => [
        'payload'  => ['permissions' => [CategoryPermissions::Store]],
        'expected' => ['status' => 201]
    ],
