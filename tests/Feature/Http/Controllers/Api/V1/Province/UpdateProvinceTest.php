...
it('update province', function (array $payload = [], array $expected = []) {
    ...
    $response = login(permissions: Arr::get($payload, 'permissions', [SharedPermissions::Admin]))->patchJson('api/v1/province/' . $model->id, $data);
    ...
    'default data with permission'    => [
        'payload'  => ['permissions' => [ProvincePermissions::Update]],
        'expected' => ['status' => 202]
    ],
