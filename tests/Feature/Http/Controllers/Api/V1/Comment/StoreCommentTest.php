...
it('create category', function (array $payload = [], array $expected = []) {
    ...
    $response = login(permissions: Arr::get($payload, 'permissions', [SharedPermissions::Admin]))->postJson('api/v1/comment', $data);
    ...
    'default data with permission'    => [
        'payload'  => ['permissions' => [CommentPermissions::Store]],
        'expected' => ['status' => 201]
    ],
