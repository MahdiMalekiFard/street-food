...
it('create category', function (array $payload = [], array $expected = []) {
    ...
    $response = login(permissions: Arr::get($payload, 'permissions', [SharedPermissions::Admin]))->postJson('api/v1/activation-code', $data);
    ...
    'default data with permission'    => [
        'payload'  => ['permissions' => [ActivationCodePermissions::Store]],
        'expected' => ['status' => 201]
    ],
