...
it('update activationCode', function (array $payload = [], array $expected = []) {
    ...
    $response = login(permissions: Arr::get($payload, 'permissions', [SharedPermissions::Admin]))->patchJson('api/v1/activation-code/' . $model->id, $data);
    ...
    'default data with permission'    => [
        'payload'  => ['permissions' => [ActivationCodePermissions::Update]],
        'expected' => ['status' => 202]
    ],
