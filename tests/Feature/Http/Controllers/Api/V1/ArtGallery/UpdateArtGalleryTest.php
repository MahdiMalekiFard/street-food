...
it('update artGallery', function (array $payload = [], array $expected = []) {
    ...
    $response = login(permissions: Arr::get($payload, 'permissions', [SharedPermissions::Admin]))->patchJson('api/v1/art-gallery/' . $model->id, $data);
    ...
    'default data with permission'    => [
        'payload'  => ['permissions' => [ArtGalleryPermissions::Update]],
        'expected' => ['status' => 202]
    ],
