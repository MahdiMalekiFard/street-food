...
it('create category', function (array $payload = [], array $expected = []) {
    ...
    $response = login(permissions: Arr::get($payload, 'permissions', [SharedPermissions::Admin]))->postJson('api/v1/opinion', $data);
    ...
    'default data with permission'    => [
        'payload'  => ['permissions' => [OpinionPermissions::Store]],
        'expected' => ['status' => 201]
    ],
