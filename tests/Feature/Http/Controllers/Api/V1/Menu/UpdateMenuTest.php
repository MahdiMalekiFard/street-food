...
it('update menu', function (array $payload = [], array $expected = []) {
    ...
    $response = login(permissions: Arr::get($payload, 'permissions', [SharedPermissions::Admin]))->patchJson('api/v1/menu/' . $model->id, $data);
    ...
    'default data with permission'    => [
        'payload'  => ['permissions' => [MenuPermissions::Update]],
        'expected' => ['status' => 202]
    ],
