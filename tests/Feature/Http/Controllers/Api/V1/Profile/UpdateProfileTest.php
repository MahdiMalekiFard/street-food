...
it('update profile', function (array $payload = [], array $expected = []) {
    ...
    $response = login(permissions: Arr::get($payload, 'permissions', [SharedPermissions::Admin]))->patchJson('api/v1/profile/' . $model->id, $data);
    ...
    'default data with permission'    => [
        'payload'  => ['permissions' => [ProfilePermissions::Update]],
        'expected' => ['status' => 202]
    ],
