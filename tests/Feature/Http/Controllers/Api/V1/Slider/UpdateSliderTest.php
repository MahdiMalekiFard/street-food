...
it('update slider', function (array $payload = [], array $expected = []) {
    ...
    $response = login(permissions: Arr::get($payload, 'permissions', [SharedPermissions::Admin]))->patchJson('api/v1/slider/' . $model->id, $data);
    ...
    'default data with permission'    => [
        'payload'  => ['permissions' => [SliderPermissions::Update]],
        'expected' => ['status' => 202]
    ],
